...
Consul and Vault guild, Terraform guild
began training to become an interviewer

## September 2020 - March 2021

transitioned teams to Product Platform

Initial activities around moving to Quartermaster / AWS [standardization]
Analyzed EVNT-2639 and EVNT-2710 for DREMR team
Analyzed EVNT-2770 with Learning for Incidents: interviews, timelines, document/slide writing/editing, co-led the Learning Review meeting
Created SLOs, reduced alert noise, moved monitors into Terraform
...
Planned DREMR migration to AWS:
  ...
  * created a plan which stood up client-facing services first, to unblock other teams' migrations, then our own internal stack
  * dovetailed this plan with those of other teams and departments
Implemented department-level KPIs -- selected candidate functionality, reviewed with engineering/PMs, confirmed existing metrics, extended existing Terraform module, created new KPIs using Terraform
Helped onboard new SRE manager -- explained org structure, software architecture of team's systems as well as Indeed's systems
Mentored SRE 2.5
Analyzed EVNT-3067 and EVNT-3112, creating an intro/outro script used by subsequent analysts, as well as a wiki page accumulating tips for interviews, analysis, and document creation
Improved team operational processes

## September 2021 - March 2022

Finished planning DREMR migration to AWS; executing majority of migration tasks; coordinated with stakeholders; worked closely with partner teams
Assisted with Payments Platform AWS migration
Supported SYD, IAD, DUBPROD1 gamedays -- finding potential gap in default healthcheck behavior across Indeed
Led the Conversations Platform effort to leave multiple datacenters -- planned, executed, delegated
Modified monitors to reduce alert noise
Created proof-of-concept tools to ease initial integration with AWS WAF -- generating, capturing and parsing logs -- later integrated this functionality into the modules used to manage all Indeed ALBs
Nearing calibrated on Troubleshooting Discussion interview type -- shadowed 5 and led 5 myself
Began developing signals document for TSD interview type
